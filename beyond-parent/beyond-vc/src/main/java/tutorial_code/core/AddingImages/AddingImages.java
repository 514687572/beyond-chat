package tutorial_code.core.AddingImages;
...
class AddingImagesRun{
    public void run() {
        ...
        //! [load]
        src1 = Imgcodecs.imread("E:\\tools\\opencv\\sources\\samples\\data\\LinuxLogo.jpg");
        src2 = Imgcodecs.imread("E:\\tools\\opencv\\sources\\samples\\data\\WindowsLogo.jpg");
        //! [load]
