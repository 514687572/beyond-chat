package tutorial_code.ImgProc.morph_lines_detection;
...
/*        if (args.length == 0){
            ...
            System.out.println("Program Arguments: [E:\\tools\\opencv\\sources\\samples\\data\\lena.jpg]");
            System.exit(-1);
        }*/

        // Load the image
        Mat src = Imgcodecs.imread("E:\\\\tools\\\\opencv\\\\sources\\\\samples\\\\data\\\\lena.jpg");
