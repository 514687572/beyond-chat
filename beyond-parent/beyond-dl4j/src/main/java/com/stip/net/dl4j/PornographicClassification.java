...
public class PornographicClassification {
    protected static final Logger log = LoggerFactory.getLogger(PornographicClassification.class);
    protected static int height = 100;
    protected static int width = 100;
    protected static int channels = 3;
    protected static int batchSize = 285;//285
    ...
    public void run(String[] args) throws Exception {
        ...
        File mainPath = new File(this.getClass().getClassLoader().getResource("").getPath(), "/animals/");
         ...
         **/
        InputSplit[] inputSplit = fileSplit.sample(pathFilter, 1.0-splitTrainTest, splitTrainTest);
        ...
        ImageTransform colorTransform = new ColorConversionTransform(new Random(seed), 1);
...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, iterations).init();
    ...
    public MultiLayerNetwork lenetModel() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .regularization(false).l2(0.08) // tried 0.0001, 0.0005
    ...
    public static void main(String[] args) throws Exception {
        new PornographicClassification().run(args);
    }
